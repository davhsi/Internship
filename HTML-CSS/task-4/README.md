...
Ensure that the entire experience is responsive and leverages advanced CSS techniques (e.g., combining Flexbox, Grid, and pseudo-classes) to manage layout and state transition

**Output**

**Desktop view**

![desktop](./assets/desktop-view.gif)

**Mobile view **

![mobile](./assets/mobile-view.gif)